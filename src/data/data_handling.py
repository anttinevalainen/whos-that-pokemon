...
def get_silhouette_photoimage(silhouette_filename):
    ...
    '''takes the filename of the silhouette in data/png folder'''
...
def get_pokemon_photoimage(filename):
    ...
    '''takes the filename of the pokemon in data/png folder'''
...
def get_pokemon_data():
    '''returns all the data stated in data/data_handling.py in one single get command revolving around a single random pokemon
